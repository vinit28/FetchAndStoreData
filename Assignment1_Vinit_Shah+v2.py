...
def insertVariant():
    query_template = '''INSERT IGNORE INTO NYTimes2.Articles(url, title, Description, published_date, section, entity, sentiment_type, Shares, Time) 
    ...
    for entry in data:
        ...
        Time = int(time.time())
        query_parameters = (url, title, Description, date, section, entity, sentiment_type, Shares, Time)
...
###################
def insertInvariant():
    query_template = '''INSERT IGNORE INTO NYTimes2.Articles_Constant(url, title, Description, published_date, section, entity, sentiment_type, Shares) 
    ...
    for entry in data:
        ...
        entity = getEntity(url)
        sentiment_type = getSentiment(url)
        query_parameters = (url, title, Description, date, section, entity, sentiment_type, Shares)
        cursor.execute(query_template, query_parameters)
